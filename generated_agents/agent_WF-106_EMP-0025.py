...
# Generated Agent for Workflow: WF-106
# Employee: EMP-0025
# Pattern: brave.exe:Custom_CLICK->brave.exe:Custom_CLICK->brave.exe:Custom_CLICK->brave.exe:CLICK->brave.exe:TYPE


def run_agent():
    print(f"--- Start Generated Agent for WF-106 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-23 07:16:53.473120+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb23/e550c5d0-7c75-401f-8c81-8e01be9b9332.webp",
                "app_name": "brave.exe",
        ...
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-23 07:16:55.404554+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb23/4445e69c-5730-4d07-9b40-9a009559da23.webp",
                "app_name": "brave.exe",
                "window_title": "Fix of warehouse - Google Sheets - Brave",
                "event": "Custom_CLICK",
                "url": "docs.google.com/spreadsheets/d/1UByYg7_GMjNIqjoXEcNezc2bNfnSVuOU8japFLXceUU/edit?gid=0#gid=0",
