...
# Generated Agent for Workflow: WF-127
# Employee: EMP-0025
# Pattern: Telegram.exe:APP_SWITCH->Telegram.exe:TYPE->Telegram.exe:Custom_CLICK->Telegram.exe:APP_SWITCH->Telegram.exe:APP_SWITCH


def run_agent():
    print(f"--- Start Generated Agent for WF-127 ---")
    pyautogui.PAUSE = 1.0
    ...
    steps = [
        ...
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-23 07:26:50.791000+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb23/823a5845-3363-4ca3-8ec6-3704485796b9.webp",
                "app_name": "Telegram.exe",
                "window_title": "\u200eKirubel Chip @ \u200eNA (6796)",
                "event": "APP_SWITCH",
                "url": "",
