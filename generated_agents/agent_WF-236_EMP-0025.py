...
# Generated Agent for Workflow: WF-236
# Employee: EMP-0025
# Pattern: Postman.exe:Custom_CLICK->brave.exe:Custom_CLICK->brave.exe:Custom_CLICK->Postman.exe:Custom_CLICK->brave.exe:Custom_CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-236 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-23 16:39:53.616093+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb23/57f93d25-b600-4564-93ba-7131e633d4a5.webp",
