...
# Generated Agent for Workflow: WF-473
# Employee: EMP-0028
# Pattern: chrome.exe:Custom_CLICK->chrome.exe:Custom_CLICK->chrome.exe:Custom_CLICK->Telegram.exe:APP_SWITCH->Telegram.exe:APP_SWITCH


def run_agent():
    print(f"--- Start Generated Agent for WF-473 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0028",
                "timestamp": "2026-02-24 09:54:19.426705+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Rihana_EMP-0028/screenshot/Feb24/088fb45e-7c86-45c6-b85c-5d08b944fdee.webp",
                "app_name": "chrome.exe",
