...
# Generated Agent for Workflow: WF-622
# Employee: EMP-0053
# Pattern: chrome.exe:Custom_CLICK->chrome.exe:MOVE->chrome.exe:CLICK->chrome.exe:Custom_CLICK->chrome.exe:CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-622 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0053",
                "timestamp": "2026-02-23 09:22:09.169407+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Betelhem_EMP-0053/screenshot/Feb23/d3c11600-af15-4b71-bab7-5a6eeb4c3606.webp",
                "app_name": "chrome.exe",
