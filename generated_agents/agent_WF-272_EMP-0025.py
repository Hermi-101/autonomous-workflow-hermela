...
# Generated Agent for Workflow: WF-272
# Employee: EMP-0025
# Pattern: brave.exe:Custom_CLICK->brave.exe:APP_SWITCH->brave.exe:Custom_CLICK->brave.exe:APP_SWITCH->brave.exe:CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-272 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-24 05:25:02.832984+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb24/1aedf51c-f06c-428a-9f98-737181c8e8f4.webp",
                "app_name": "brave.exe",
