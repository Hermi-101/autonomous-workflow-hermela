...
# Generated Agent for Workflow: WF-615
# Employee: EMP-0053
# Pattern: ShellExperienceHost.exe:Custom_CLICK->ShellExperienceHost.exe:Custom_CLICK->ShellExperienceHost.exe:Custom_CLICK->ShellExperienceHost.exe:Custom_CLICK->chrome.exe:Custom_CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-615 ---")
    pyautogui.PAUSE = 1.0
    ...
    steps = [
        ...
        {
                "id_employee": "EMP-0053",
                "timestamp": "2026-02-23 08:58:05.664382+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Betelhem_EMP-0053/screenshot/Feb23/6ae4e9d5-bec7-4206-8f69-d3223a80804f.webp",
                "app_name": "chrome.exe",
