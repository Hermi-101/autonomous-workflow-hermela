...
# Generated Agent for Workflow: WF-606
# Employee: EMP-0053
# Pattern: chrome.exe:Custom_CLICK->chrome.exe:CLICK->chrome.exe:Custom_CLICK->chrome.exe:APP_SWITCH->chrome.exe:CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-606 ---")
    pyautogui.PAUSE = 1.0
    ...
    steps = [
        ...
        {
                "id_employee": "EMP-0053",
                "timestamp": "2026-02-23 08:43:45.003000+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Betelhem_EMP-0053/screenshot/Feb23/2db60b63-3257-467b-a58a-6e8fcfc77239.webp",
                "app_name": "chrome.exe",
                "window_title": "Reports - Google Chrome",
                "event": "CLICK",
                "url": "admin.ringcloud.et/reports",
