...
# Generated Agent for Workflow: WF-539
# Employee: EMP-0028
# Pattern: EXCEL.EXE:APP_SWITCH->EXCEL.EXE:APP_SWITCH->EXCEL.EXE:APP_SWITCH->EXCEL.EXE:Custom_CLICK->EXCEL.EXE:Custom_CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-539 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0028",
                "timestamp": "2026-02-24 13:59:06.667000+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Rihana_EMP-0028/screenshot/Feb24/bdb3d557-f212-4b4c-9476-abbb22f4c61b.webp",
                "app_name": "EXCEL.EXE",
