...
# Generated Agent for Workflow: WF-607
# Employee: EMP-0053
# Pattern: chrome.exe:Custom_CLICK->chrome.exe:Custom_CLICK->chrome.exe:CLICK->chrome.exe:Custom_CLICK->chrome.exe:MOVE


def run_agent():
    print(f"--- Start Generated Agent for WF-607 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0053",
                "timestamp": "2026-02-23 08:43:50.714740+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Betelhem_EMP-0053/screenshot/Feb23/7d13517e-a4f9-4a81-aebb-e227070ac3d9.webp",
                "app_name": "chrome.exe",
        ...
        {
                "id_employee": "EMP-0053",
                "timestamp": "2026-02-23 08:43:52.479092+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Betelhem_EMP-0053/screenshot/Feb23/856e1c9a-00e5-4d1e-bd99-88c4603ea54a.webp",
                "app_name": "chrome.exe",
                "window_title": "Reports - Google Chrome",
                "event": "Custom_CLICK",
                "url": "admin.ringcloud.et/reports",
