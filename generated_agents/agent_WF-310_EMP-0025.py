...
# Generated Agent for Workflow: WF-310
# Employee: EMP-0025
# Pattern: Postman.exe:TYPE->Postman.exe:Custom_CLICK->Postman.exe:TYPE->Postman.exe:CLICK->Postman.exe:Custom_CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-310 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-24 11:35:40.004000+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb24/ab31e6ee-c6b9-4bbf-8792-25e3775b121d.webp",
