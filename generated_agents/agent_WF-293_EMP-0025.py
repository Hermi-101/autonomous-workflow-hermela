...
# Generated Agent for Workflow: WF-293
# Employee: EMP-0025
# Pattern: Telegram.exe:Custom_CLICK->Telegram.exe:APP_SWITCH->Telegram.exe:APP_SWITCH->Telegram.exe:Custom_CLICK->Telegram.exe:APP_SWITCH


def run_agent():
    print(f"--- Start Generated Agent for WF-293 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-24 08:39:35.031099+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb24/85f9413f-a451-46b8-b1c2-3af9163d8f17.webp",
        ...
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-24 08:39:36.228000+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb24/a86611ee-4422-4092-a50c-1ce0a5a75e19.webp",
                "app_name": "Telegram.exe",
