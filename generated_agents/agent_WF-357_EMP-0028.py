...
# Generated Agent for Workflow: WF-357
# Employee: EMP-0028
# Pattern: chrome.exe:Custom_CLICK->chrome.exe:APP_SWITCH->chrome.exe:Custom_CLICK->chrome.exe:Custom_CLICK->chrome.exe:APP_SWITCH


def run_agent():
    print(f"--- Start Generated Agent for WF-357 ---")
    pyautogui.PAUSE = 1.0
    ...
    steps = [
        ...
        {
                "id_employee": "EMP-0028",
                "timestamp": "2026-02-23 11:54:14.703160+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Rihana_EMP-0028/screenshot/Feb23/9bd46dcf-24c8-4b09-b0cd-4581e7d8868f.webp",
                "app_name": "chrome.exe",
