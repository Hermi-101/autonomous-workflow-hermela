...
# Generated Agent for Workflow: WF-238
# Employee: EMP-0025
# Pattern: brave.exe:Custom_CLICK->Postman.exe:Custom_CLICK->brave.exe:Custom_CLICK->Postman.exe:Custom_CLICK->Postman.exe:Custom_CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-238 ---")
    pyautogui.PAUSE = 1.0
    ...
    steps = [
        ...
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-23 16:40:25.649686+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb23/4c85d0d5-87ed-4fe2-a3b2-4485d4a99ff4.webp",
                "app_name": "Postman.exe",
