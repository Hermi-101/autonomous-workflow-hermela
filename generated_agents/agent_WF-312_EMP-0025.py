...
# Generated Agent for Workflow: WF-312
# Employee: EMP-0025
# Pattern: Postman.exe:TYPE->Postman.exe:CLICK->Postman.exe:Custom_CLICK->Postman.exe:Custom_CLICK->Postman.exe:Custom_CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-312 ---")
    pyautogui.PAUSE = 1.0
    ...
    steps = [
        ...
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-24 11:36:10.707900+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb24/1f6e79f1-1672-4f4e-bf6c-c87c77f02a96.webp",
                "app_name": "Postman.exe",
                "window_title": "Manual allocates stock for all delivery tracks Copy - My Workspace",
                "event": "Custom_CLICK",
                "url": "",
