...
# Generated Agent for Workflow: WF-610
# Employee: EMP-0053
# Pattern: chrome.exe:Custom_CLICK->chrome.exe:MOVE->chrome.exe:CLICK->chrome.exe:Custom_CLICK->chrome.exe:MOVE


def run_agent():
    print(f"--- Start Generated Agent for WF-610 ---")
    pyautogui.PAUSE = 1.0
    ...
    steps = [
        ...
        {
                "id_employee": "EMP-0053",
                "timestamp": "2026-02-23 08:45:20.003000+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Betelhem_EMP-0053/screenshot/Feb23/9925a0ab-581e-432b-8484-34ed463b0619.webp",
                "app_name": "chrome.exe",
                "window_title": "Reports - Google Chrome",
                "event": "MOVE",
                "url": "admin.ringcloud.et/reports",
