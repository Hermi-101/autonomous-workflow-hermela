...
# Generated Agent for Workflow: WF-656
# Employee: EMP-0053
# Pattern: chrome.exe:Custom_CLICK->chrome.exe:CLICK->chrome.exe:Custom_CLICK->chrome.exe:Custom_CLICK->chrome.exe:TYPE


def run_agent():
    print(f"--- Start Generated Agent for WF-656 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0053",
                "timestamp": "2026-02-23 12:36:09.527150+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Betelhem_EMP-0053/screenshot/Feb23/faa8abde-a4fd-4d8d-9a73-79b53a57d89b.webp",
                "app_name": "chrome.exe",
