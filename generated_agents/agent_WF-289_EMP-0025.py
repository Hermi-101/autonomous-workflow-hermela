...
# Generated Agent for Workflow: WF-289
# Employee: EMP-0025
# Pattern: Postman.exe:Custom_CLICK->Postman.exe:APP_SWITCH->Postman.exe:APP_SWITCH->Postman.exe:TYPE->Postman.exe:Custom_CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-289 ---")
    pyautogui.PAUSE = 1.0
    ...
    steps = [
        ...
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-24 08:26:21.416302+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb24/cd84bef6-13de-4634-aa38-2cb84e03dffc.webp",
                "app_name": "Postman.exe",
                "window_title": "order report - My Workspace",
                "event": "Custom_CLICK",
                "url": "",
