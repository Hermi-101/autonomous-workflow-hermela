...
# Generated Agent for Workflow: WF-219
# Employee: EMP-0025
# Pattern: brave.exe:Custom_CLICK->brave.exe:Custom_COPY_ACTION->brave.exe:Custom_CLICK->brave.exe:Custom_CLICK->brave.exe:Custom_CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-219 ---")
    pyautogui.PAUSE = 1.0
    ...
    steps = [
        ...
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-23 12:01:58.049905+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb23/81faef5e-8f22-4f8f-a5f9-eabc85dfacc5.webp",
                "app_name": "brave.exe",
        ...
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-23 12:02:00.004425+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb23/b9f08387-8e84-43c2-8148-1f08587c8ba0.webp",
                "app_name": "brave.exe",
                "window_title": "Fix of warehouse - Google Sheets - Brave",
                "event": "Custom_CLICK",
                "url": "docs.google.com/spreadsheets/d/1UByYg7_GMjNIqjoXEcNezc2bNfnSVuOU8japFLXceUU/edit?gid=895107596#gid=895107596",
