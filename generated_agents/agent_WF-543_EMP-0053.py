...
# Generated Agent for Workflow: WF-543
# Employee: EMP-0053
...
def run_agent():
    print(f"--- Start Generated Agent for WF-543 ---")
    pyautogui.PAUSE = 1.0
    ...
    steps = [
        ...
        {
                "id_employee": "EMP-0053",
                "timestamp": "2026-02-23 07:51:58.387915+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Betelhem_EMP-0053/screenshot/Feb23/4fbc26b3-4200-437e-aea4-e2aed25c55f1.webp",
                "app_name": "Telegram.exe",
                "window_title": "\u200eChip Chip Social (5518)",
                "event": "Custom_CLICK",
                "url": "",
                "date": "2026-02-23"
        }
