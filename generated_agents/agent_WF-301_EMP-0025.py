...
# Generated Agent for Workflow: WF-301
# Employee: EMP-0025
# Pattern: brave.exe:Custom_CLICK->brave.exe:APP_SWITCH->brave.exe:TYPE->brave.exe:Custom_CLICK->brave.exe:Custom_CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-301 ---")
    pyautogui.PAUSE = 1.0
    ...
    steps = [
        ...
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-24 09:08:11.850973+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb24/ca30da9d-9a95-4249-a731-885aa17cf9b4.webp",
                "app_name": "brave.exe",
                "window_title": "Warehouse inventory February 2026 - Google Sheets - Brave",
                "event": "Custom_CLICK",
