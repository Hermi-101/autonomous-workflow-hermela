...
# Generated Agent for Workflow: WF-514
# Employee: EMP-0028
# Pattern: Telegram.exe:Custom_CLICK->Telegram.exe:APP_SWITCH->Telegram.exe:CLICK->Telegram.exe:APP_SWITCH->Telegram.exe:TYPE


def run_agent():
    print(f"--- Start Generated Agent for WF-514 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0028",
                "timestamp": "2026-02-24 12:35:24.381214+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Rihana_EMP-0028/screenshot/Feb24/aa828752-1a22-466b-af9b-9910eba059a2.webp",
