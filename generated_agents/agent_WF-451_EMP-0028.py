...
# Generated Agent for Workflow: WF-451
# Employee: EMP-0028
# Pattern: chrome.exe:Custom_CLICK->chrome.exe:Custom_CLICK->Telegram.exe:Custom_CLICK->Telegram.exe:Custom_CLICK->Telegram.exe:APP_SWITCH


def run_agent():
    print(f"--- Start Generated Agent for WF-451 ---")
    pyautogui.PAUSE = 1.0
    ...
    steps = [
        ...
        {
                "id_employee": "EMP-0028",
                "timestamp": "2026-02-24 08:36:46.403000+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Rihana_EMP-0028/screenshot/Feb24/8215d88f-f295-48d3-938f-b17a9e896f7a.webp",
                "app_name": "Telegram.exe",
                "window_title": "\u200eBruk \u2013 (879436)",
                "event": "APP_SWITCH",
                "url": "",
                "date": "2026-02-24"
        }
