...
# Generated Agent for Workflow: WF-440
# Employee: EMP-0028
...
def run_agent():
    print(f"--- Start Generated Agent for WF-440 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0028",
                "timestamp": "2026-02-24 08:24:52.162993+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Rihana_EMP-0028/screenshot/Feb24/02ffb0db-ef1f-4c93-977d-b864206db2db.webp",
                "app_name": "chrome.exe",
