...
# Generated Agent for Workflow: WF-516
# Employee: EMP-0028
# Pattern: Telegram.exe:CLICK->Telegram.exe:APP_SWITCH->Telegram.exe:TYPE->Telegram.exe:Custom_CLICK->Telegram.exe:Custom_CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-516 ---")
    pyautogui.PAUSE = 1.0
    ...
    steps = [
        ...
        {
                "id_employee": "EMP-0028",
                "timestamp": "2026-02-24 12:35:44.465925+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Rihana_EMP-0028/screenshot/Feb24/4b4a6df9-7fb5-4a5d-a93c-920df166d44e.webp",
                "app_name": "Telegram.exe",
                "window_title": "\u200eRas Mtat \u2013 (879747)",
                "event": "Custom_CLICK",
                "url": "",
