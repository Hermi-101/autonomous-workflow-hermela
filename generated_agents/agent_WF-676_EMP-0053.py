...
# Generated Agent for Workflow: WF-676
# Employee: EMP-0053
# Pattern: chrome.exe:APP_SWITCH->chrome.exe:APP_SWITCH->chrome.exe:APP_SWITCH->chrome.exe:CLICK->chrome.exe:Custom_CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-676 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0053",
                "timestamp": "2026-02-23 13:59:37.209000+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Betelhem_EMP-0053/screenshot/Feb23/d5855ec4-025c-4110-8638-b916619d14e7.webp",
                "app_name": "chrome.exe",
