...
# Generated Agent for Workflow: WF-260
# Employee: EMP-0025
# Pattern: Postman.exe:TYPE->Postman.exe:Custom_CLICK->Postman.exe:APP_SWITCH->Postman.exe:Custom_CLICK->Postman.exe:APP_SWITCH


def run_agent():
    print(f"--- Start Generated Agent for WF-260 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-24 05:17:35.014000+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb24/59fe323f-b6cb-450c-8b9d-cd5412f843a6.webp",
