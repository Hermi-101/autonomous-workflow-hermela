...
# Generated Agent for Workflow: WF-527
# Employee: EMP-0028
# Pattern: chrome.exe:Custom_CLICK->chrome.exe:Custom_PASTE_ACTION->chrome.exe:Custom_PASTE_ACTION->chrome.exe:Custom_CLICK->chrome.exe:Custom_CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-527 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0028",
                "timestamp": "2026-02-24 13:15:03.106485+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Rihana_EMP-0028/screenshot/Feb24/b1088547-3b7b-4c3a-aebf-55e3f7a51c80.webp",
                "app_name": "chrome.exe",
