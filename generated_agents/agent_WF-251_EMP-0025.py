...
# Generated Agent for Workflow: WF-251
# Employee: EMP-0025
# Pattern: Postman.exe:Custom_CLICK->Postman.exe:CLICK->Postman.exe:Custom_CLICK->Postman.exe:Custom_CLICK->Postman.exe:Custom_CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-251 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-24 05:07:34.147618+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb24/c318d5b7-d9b1-4fdb-b24c-161c7161268a.webp",
