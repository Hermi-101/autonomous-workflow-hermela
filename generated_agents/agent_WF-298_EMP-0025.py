...
# Generated Agent for Workflow: WF-298
# Employee: EMP-0025
# Pattern: brave.exe:CLICK->brave.exe:APP_SWITCH->brave.exe:Custom_CLICK->brave.exe:TYPE->brave.exe:Custom_CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-298 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-24 08:48:35+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb24/86e532f3-da2d-4b45-80ce-68eb74ec2a30.webp",
                "app_name": "brave.exe",
