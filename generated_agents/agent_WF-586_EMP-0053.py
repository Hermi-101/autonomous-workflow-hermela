...
# Generated Agent for Workflow: WF-586
# Employee: EMP-0053
# Pattern: chrome.exe:Custom_CLICK->chrome.exe:Custom_CLICK->chrome.exe:APP_SWITCH->chrome.exe:Custom_CLICK->chrome.exe:CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-586 ---")
    pyautogui.PAUSE = 1.0

    steps = [
        {
                "id_employee": "EMP-0053",
                "timestamp": "2026-02-23 08:24:57.341314+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Betelhem_EMP-0053/screenshot/Feb23/a863b8e9-a6a7-48f8-acd5-966148bc7678.webp",
                "app_name": "chrome.exe",
        ...
        {
                "id_employee": "EMP-0053",
                "timestamp": "2026-02-23 08:25:01.598640+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Betelhem_EMP-0053/screenshot/Feb23/5c9b3676-73af-434a-9d8b-e3403f0b6d80.webp",
                "app_name": "chrome.exe",
        ...
        {
                "id_employee": "EMP-0053",
                "timestamp": "2026-02-23 08:25:06.468000+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Betelhem_EMP-0053/screenshot/Feb23/84d9899c-47d2-43f2-877b-8e16ea2d82c6.webp",
                "app_name": "chrome.exe",
