...
# Generated Agent for Workflow: WF-262
# Employee: EMP-0025
# Pattern: Postman.exe:APP_SWITCH->Postman.exe:Custom_CLICK->Postman.exe:APP_SWITCH->Postman.exe:TYPE->Postman.exe:Custom_CLICK


def run_agent():
    print(f"--- Start Generated Agent for WF-262 ---")
    pyautogui.PAUSE = 1.0
    ...
    steps = [
        ...
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-24 05:17:50.959073+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb24/b31ed86c-c646-4cdb-830c-9770c1937cee.webp",
                "app_name": "Postman.exe",
                "window_title": "product detail - My Workspace",
                "event": "Custom_CLICK",
                "url": "",
