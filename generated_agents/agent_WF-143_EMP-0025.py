...
# Generated Agent for Workflow: WF-143
# Employee: EMP-0025
# Pattern: brave.exe:TYPE->brave.exe:TYPE->brave.exe:Custom_CLICK->brave.exe:Custom_CLICK->brave.exe:TYPE


def run_agent():
    print(f"--- Start Generated Agent for WF-143 ---")
    pyautogui.PAUSE = 1.0
    ...
    steps = [
        ...
        {
                "id_employee": "EMP-0025",
                "timestamp": "2026-02-23 07:38:15.010000+00:00",
                "image_path": "https://fra1.digitaloceanspaces.com/mgscreenshot/chipchip_data/Natnael_EMP-0025/screenshot/Feb23/ce7bbd13-7f0e-4359-9075-ad496b9a12bf.webp",
                "app_name": "brave.exe",
                "window_title": "ChipChip Project Report Week 08, 2026 (Feb 16 - Feb 22) - Google Slides - Brave",
                "event": "TYPE",
                "url": "docs.google.com/presentation/d/1W9WyQLl8IuMMhkfkDVCNXvjhjuQCFB3XEysWAz-33hw/edit?slide=id.g3be12b1b3f4_0_148#slide=id.g3be12b1b3f4_0_148",
